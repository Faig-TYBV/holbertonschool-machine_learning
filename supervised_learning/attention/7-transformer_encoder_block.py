#!/usr/bin/env python3
"""Module that defines the EncoderBlock class for a Transformer encoder.
"""
...
class EncoderBlock(tf.keras.layers.Layer):
    ...
    def call(self, x, training, mask=None):
        """Executes the forward pass for the encoder block.
        ...
        """
        # Multi-head attention layer expects Q, K, V, mask
